...
public class OrExpression extends Expression {
	...
	public OrExpression(Expression e0, Expression e1) {
		this.e0 = e0;
		this.e1 = e1;
	}
	...
	public BigInteger evaluate(Context context) {
		return e0.evaluate(context).or(e1.evaluate(context));
	}
	...
	public Expression simplify() {
		if (e0 instanceof LiteralExpression && e1 instanceof LiteralExpression) {
			...
			return new LiteralExpression(left.getValue().or(right.getValue()), this);
		}
	...
	@Override
	public int hashCode() {
		return e0.hashCode()+e1.hashCode()+24322123;
	}
